...
| --- | --- |
| UiPath-Git Integration | A simple demo showcasing GitHub-based source control integration in UiPath. View it on <a href="https://github.com/alfredbot01?tab=repositories">GitHub</a>. <br><br> <!---![alt_text](https://github.com/bacdillon/AutomationTesting/blob/main/others.png) --> |
...
| Client Enrollment - How HubSpot CRM platform with RPA Integration Transforms Operations | The objectives is to : <br> 1. Enhancing Data Accuracy and Quality <br> 2. Boosting Operational Efficiency <br> 3. Automating Routine Customer Interactions 4. Enabling Personalized Customer Experiences <br> |
