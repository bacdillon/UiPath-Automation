...
| --- | --- |
| A test automation for CRM application workflows, with UiPath-Git Integration | A simple demo showcasing GitHub-based source control integration in UiPath. View it on <a href="https://github.com/alfredbot01?tab=repositories">GitHub</a>. <br><br> <!---![alt_text](https://github.com/bacdillon/AutomationTesting/blob/main/others.png) --> |
